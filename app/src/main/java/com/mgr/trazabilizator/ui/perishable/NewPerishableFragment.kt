...
class NewPerishableFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_newperishable, container, false)
        return root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.buttonChooseExpiryDate).setOnClickListener() {
            nav.navigate(R.id.nav_expiryDateFragment)
        }
        ...
        parentFragmentManager.setFragmentResultListener(
            ...
            this,
            FragmentResultListener { _, result ->
                var expiryDate: String? = result.getString("expiryDate")
    ...
    fun reset(view: View, responsable: String) {
        ...
        view.findViewById<TextInputEditText>(R.id.TextInputEditTextTemperature).setText("")
