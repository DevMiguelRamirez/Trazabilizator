package com.mgr.trazabilizator.ui.endDate
...
class EndDateFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.buttonChoose).setOnClickListener {
            ...
            bundle.putString("endDate", date.trim())
            parentFragmentManager.setFragmentResult("endDate", bundle)
            nav.popBackStack()
        }
    }
}