package com.mgr.trazabilizator.ui.preferentialDate
...
class PreferentialDateFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.buttonChoose).setOnClickListener {
            ...
            bundle.putString("preferentialDate", date.trim())
            parentFragmentManager.setFragmentResult("preferentialDate", bundle)
            nav.popBackStack()
        }
    }
}