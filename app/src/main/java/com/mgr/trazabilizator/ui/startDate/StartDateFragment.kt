package com.mgr.trazabilizator.ui.startDate
...
class StartDateFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.buttonChoose).setOnClickListener {
            ...
            bundle.putString("startDate", date.trim())
            parentFragmentManager.setFragmentResult("startDate", bundle)
            nav.popBackStack()
        }
    }
}